...
\filldraw[fill=white, draw=black] (2.5,2.5) rectangle (2.9000000000000004,2.9000000000000004) node at (2.9200000000000004,2.7) [right] {$\scriptstyle S^Z_{0}$};
\filldraw[fill=white, draw=black] (0.7,0.7) rectangle (1.1,1.1) node at (1.12,0.9) [right] {$\scriptstyle S^Z_{1}$};
\filldraw[fill=white, draw=black] (0.7,4.3) rectangle (1.1,4.7) node at (1.12,4.5) [right] {$\scriptstyle S^Z_{2}$};
\filldraw[fill=white, draw=black] (2.5,-1.1) rectangle (2.9000000000000004,-0.7) node at (2.9200000000000004,-0.9) [right] {$\scriptstyle S^Z_{3}$};
\end{tikzpicture}
\end{document}
